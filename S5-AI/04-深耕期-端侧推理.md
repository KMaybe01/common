...
- [核心实现](#-核心实现)
  ...
  - [WebGPU 加速引擎](#35-webgpu-加速引擎)
- [实战项目](#-阶段三实战项目)

### 💡 你将学到
- 浏览器端机器学习原理（WebAssembly / WebGPU / WebGL）
- Transformers.js 的 Pipeline 机制与模型懒加载
- ONNX 格式量化模型的加载与运行
- WebGPU 硬件加速推理与 GPU 适配降级
- IndexedDB 模型缓存与离线可用性实现

### 🔗 前置知识
- 完成 [🔵 阶段二：进阶期](./03-进阶期-RAG应用.md)
...
### ⚡ WebGPU Compute Shader 编程详解

> **深入 GPU 编程**：理解 Compute Shader 是优化端侧推理性能的关键，本节用矩阵乘法示例讲解完整的 WebGPU 计算管线。
...
#### WGSL (WebGPU Shading Language) 基础
...
| 文档 | 内容 | 相关章节 |
|:---|:---|:---|
| [📊 技术选型对比合集](./08-技术选型对比合集.md) | WebGPU/ONNX/Transformers.js 横向对比 | 边缘计算方案、性能基准 |
| [🛠️ 开发实战与架构指南](./09-开发实战与架构指南.md) | 前端性能优化 Checklist、WebGPU 加速 | 第6章：性能优化终极 Checklist |

---

### 📌 导航

| [⬅️ 上一阶段：进阶期](./03-进阶期-RAG应用.md) | [🏠 返回主指南](./01-AI前端开发体系化学习指南.md) | [➡️ 下一阶段：专家期 - Agent](./05-专家期-Agent设计.md) |
|:---:|:---:|:---:|
