...
> **从实战中来，到实战中去** — 本文档摘录自 [《README》](./README.md) 中的实用开发指南、架构模式、部署案例与工程化最佳实践，帮助开发者快速定位问题、优化性能、构建生产级 AI 应用。
...
| [⬅️ 技术选型对比合集](./07-技术选型对比合集.md) | [🏠 返回主指南](./README.md) | [➡️ 附录与参考资料](./09-附录与参考资料.md) |
|:---:|:---:|:---:|
...
- [5. 🔗 [LangGraph](https://langchain-ai.github.io/langgraph) 工作流编排](#5--[LangGraph](https://langchain-ai.github.io/langgraph)-工作流编排)
- [6. ⚡ 前端 AI 性能优化终极 Checklist](#6--前端-ai-性能优化终极-checklist)
- [7. 💰 AI 成本估算与控制](#7--ai-成本估算与控制)
- [8. 🛠️ 本地开发环境搭建 ([Ollama](https://ollama.ai))](#8-️-本地开发环境搭建-[Ollama](https://ollama.ai))
...
| 工具 | 用途 | 推荐场景 |
|:---|:---|:---|
| **[Vercel](https://vercel.com) AI Playground** | 快速测试 Prompt | Prompt 迭代优化 |
| **[LangSmith](https://smith.langchain.com)** | 追踪 LLM 调用链 | RAG/Agent 调试 |
| **Chrome DevTools** | 网络/性能分析 | 流式响应调试 |
| **[WebGPU](https://www.w3.org/TR/webgpu/) Inspector** | GPU 状态监控 | 端侧推理优化 |
...
| **[LangSmith](https://smith.langchain.com)** | 可视化追踪，支持数据集对比 | 全链路调试与监控 |
...
| **A**djustments | 调整参数 | "使用 [TypeScript](https://www.typescriptlang.org)，保持代码简洁..." |
...
### 🎨 渲染层
- [ ] 使用**虚拟列表**渲染长对话历史（如 `[React](https://react.dev)-window`）。
...
- **macOS/Windows/Linux**: 前往 [[Ollama](https://ollama.ai).com](https://[Ollama](https://ollama.ai).com) 下载安装包。
- **验证安装**: 运行 `[Ollama](https://ollama.ai) --version`。
...
| 库名称 | 核心功能 | 推荐指数 |
|:---|:---|:---:|
| **[[Vercel](https://vercel.com) AI SDK UI](https://sdk.[Vercel](https://vercel.com).ai/docs)** | `useChat`, `useCompletion`, 流式渲染组件 | ⭐⭐⭐⭐⭐ |
...
| 方案 | 特点 | 适用场景 |
|:---|:---|:---|
| **next-intl** | 与 [Next.js](https://nextjs.org) App Router 深度集成，类型安全 | 中大型项目，强类型要求 |
| **[React](https://react.dev)-i18next** | 生态成熟，插件丰富，支持动态加载 | 传统 [React](https://react.dev) 项目，复杂需求 |
| **[Vercel](https://vercel.com) AI SDK 内置** | 自动检测语言，模型原生支持多语言 | 纯 AI 生成内容，无需硬编码翻译 |
...
| 输出类型 | 示例 | 推荐渲染库 | 注意事项 |
|:---|:---|:---|:---|
| **Markdown** | 文章、列表、粗体 | `[React](https://react.dev)-markdown` + `remark-gfm` | 支持 GFM 表格、任务列表 |
| **代码块** | JS, Python, SQL | `[React](https://react.dev)-syntax-highlighter`, `prismjs` | 语法高亮、一键复制、行号 |
| **数学公式** | LaTeX, KaTeX | `rehype-katex`, `[React](https://react.dev)-katex` | 异步加载字体，避免闪烁 |
...
| 场景 | 常见坑 | 解决方案 |
|:---|:---|:---|
| **[Vercel](https://vercel.com) 部署** | `maxDuration` 限制导致超时 | 使用 Pro 计划 (60s) 或迁移至 AWS |
...
| 技术 | 成熟度 | 潜力 | 学习建议 |
|:---|:---:|:---:|:---|
| **[WebGPU](https://www.w3.org/TR/webgpu/)** | 🟡 发展中 | ⭐⭐⭐⭐⭐ | 立即学习，未来标配 |
| **MCP 协议** | 🟢 成熟中 | ⭐⭐⭐⭐ | 关注标准制定 |
| **A2A 协议** | 🔴 早期 | ⭐⭐⭐⭐ | 了解概念即可 |
| **WebLLM** | 🟡 发展中 | ⭐⭐⭐⭐ | 实验性使用 |
| **AI 生成 UI** | 🔴 早期 | ⭐⭐⭐ | 保持关注 |
...
| 工具 | 用途 | 推荐配置 |
|:---|:---|:---|
| **[Vite](https://vitejs.dev)st** | 单元测试 + 组件测试 | `npm [Vite](https://vitejs.dev)st -- --coverage` |
| **Testing Library** | 组件交互测试 | `@testing-library/[React](https://react.dev)` |
| **MSW** | Mock API 请求 | `msw` |
...
| [WebGPU](https://www.w3.org/TR/webgpu/) 加速 | 推理 800ms | 推理 150ms | **81%** ↓ |
