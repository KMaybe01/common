...
> 📖 本文档是 [🚀 AI 前端开发体系化学习指南](./README.md) 的附录与参考资料汇总

### 📌 导航

| [⬅️ 开发实战与架构指南](./08-开发实战与架构指南.md) | [🏠 返回主指南](./README.md) | [📊 技术选型对比合集](./07-技术选型对比合集.md) |
|:---:|:---:|:---:|

> 包含术语表、避坑指南、学习路线、FAQ、面试冲刺、职业规划等全部附录内容。
...
| 术语 | 全称 | 解释 |
|:---|:---|:---|
| **LLM** | Large Language Model | 大语言模型，如 GPT-4, Claude, [Qwen](https://qwen.alibaba.com) |
...
| **进阶期** | Day 6-8 | Embedding 原理、向量数据库 ([Pinecone](https://www.pinecone.io)) | 搭建个人知识库，支持 PDF 上传 |
| | Day 9-11 | RAG 架构、[LangChain](https://langchain.com).js、检索优化 | 实现 RAG 问答，添加引用来源 |
| **深耕期** | Day 12-14 | [Transformers.js](https://huggingface.co/docs/transformers.js)、[WebGPU](https://www.w3.org/TR/webgpu/)、端侧推理 | 在浏览器运行 [Qwen](https://qwen.alibaba.com)2.5-0.5B 模型 |
| | Day 15-16 | 模型量化、缓存策略、离线可用 | 实现模型 IndexedDB 缓存 |
| **专家期** | Day 17-20 | Agent 架构、工具调用、[React](https://react.dev) 模式 | 构建能搜索和计算的 Agent |
| | Day 21-23 | [LangGraph](https://langchain-ai.github.io/langgraph)、状态机、工作流编排 | 实现多步任务规划与执行 |
...
| **Prompt 管理** | **PromptLayer / [LangSmith](https://smith.langchain.com)** | 版本控制、A/B 测试、追踪效果 | 本地 JSON, GitHub |
| **向量数据库** | **[Pinecone](https://www.pinecone.io) / Qdrant** | 云端托管，开箱即用，支持混合检索 | [Milvus](https://milvus.io), Chroma, Weaviate |
| **本地模型** | **[Ollama](https://ollama.ai) / LM Studio** | 一键下载、运行本地 LLM，提供 API | [Llama](https://llama.meta.com).cpp, MLX |
| **前端框架** | **[Next.js](https://nextjs.org) / [Vite](https://vitejs.dev)** | SSR/SSG、路由、构建优化 | Remix, Nuxt |
| **UI 组件** | **Shadcn/UI + Tailwind** | 高度可定制，AI 友好型组件库 | Radix, MUI, AntD |
| **部署平台** | **[Vercel](https://vercel.com) / Railway** | 零配置部署，支持 Edge Runtime | AWS, [Docker](https://docker.com), K8s |
| **监控告警** | **Sentry / [Datadog](https://www.datadoghq.com)** | 错误追踪、性能监控、日志分析 | LogRocket, New Relic |
...
| **OpenOrca** | 4M+ | 大规模思维链 (CoT) 数据 | [Hugging Face](https://huggingface.co) |
...
| **[Hugging Face](https://huggingface.co) Evaluate** | 内置偏见评估模块 | 模型微调后验证 |
...
| 策略 | 工具/技术 | 效果 | 适用场景 |
|:---|:---|:---:|:---|
| **代码分割** | `[React](https://react.dev).lazy`, `next/dynamic` | 减少初始包体积 30-50% | 大型组件、非首屏功能 |
| **Tree Shaking** | Webpack/[Vite](https://vitejs.dev) 内置 | 移除未使用代码 20-40% | 所有项目 |
...
| 优化项 | 实施方法 | 优先级 |
|:---|:---|:---:|
| **SSR/SSG 渲染** | [Next.js](https://nextjs.org) App Router, `generateStaticParams` | 🔴 高 |
...
| **端侧** | [WebGPU](https://www.w3.org/TR/webgpu/) vs WebGL | 通用计算 (GPGPU) vs 图形渲染、性能差异 |
| **Agent** | [React](https://react.dev) 模式原理 | Thought-Action-Observation 循环、工具调用 |
...
| **推理速度慢** | 设备性能限制 | 启用 [WebGPU](https://www.w3.org/TR/webgpu/)，减小模型规模 |
...
### 📖 官方文档
- [[Vercel](https://vercel.com) AI SDK](https://sdk.[Vercel](https://vercel.com).ai/docs) | [[LangChain](https://langchain.com).js](https://js.[LangChain](https://langchain.com).com/docs)
- [Transformers.js](https://huggingface.co/docs/[Transformers.js](https://huggingface.co/docs/transformers.js)) | [MCP Protocol](https://modelcontextprotocol.io/)
...
### 🌐 社区与讨论
- [[Vercel](https://vercel.com) AI Discord](https://discord.gg/[Vercel](https://vercel.com)) | [AI Engineering Reddit](https://www.reddit.com/r/aiengineering/)
...
| **v1.3** | 2026-05-17 | 新增 Prompt Engineering、[LangGraph](https://langchain-ai.github.io/langgraph)、性能 Checklist 及职业规划 |
| **v1.4** | 2026-05-17 | 新增成本估算、本地开发、无障碍设计、评估流水线及 UI 库推荐 |
| **v1.5** | 2026-05-17 | 新增 [Next.js](https://nextjs.org) 架构实践、AI 架构模式对比与选型指南 |
...
| **v3.0** | 2026-05-17 | 新增评估框架对比、缓存策略矩阵与 [Redis](https://redis.io) 实战，完善质量与性能体系 |
...
| **v3.6** | 2026-05-25 | 新增单元测试与组件测试实战，覆盖 [Vite](https://vitejs.dev)st/Testing Library/Playwright |
