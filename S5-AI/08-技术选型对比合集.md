...
> 本文档提取自 [01-AI前端开发体系化学习指南](./01-AI前端开发体系化学习指南.md)，汇总了所有技术选型对比、方案评估与性能基准表格，方便快速查阅与横向比较。
...
| [⬅️ 前沿技术与生态](./07-前沿技术与生态.md) | [🏠 返回主指南](./01-AI前端开发体系化学习指南.md) | [➡️ 开发实战与架构指南](./09-开发实战与架构指南.md) |
|:---:|:---:|:---:|
