...
| **[🔧 12 工具与协议篇](./11-工具协议篇.md)** | Function Calling、MCP、A2A、SSE/WebSocket、AI Gateway | 16 题 |
| **[📐 13 大模型基础篇](./12-大模型基础篇.md)** | Transformer、RLHF/DPO/GRPO、RAG、模型评估、多模态 VLM | 84 题 |
| **[🔗 14 框架与工具链篇](./13-框架工具链篇.md)** | LangChain、CrewAI、AutoGen、vLLM、SGLang、Dify | 20 题 |
| **[🚀 15 实战项目篇](./14-实战项目篇.md)** | 架构设计、性能优化、成本控制、安全监控、CI/CD | 25 题 |
| **[🔮 16 前沿趋势篇](./15-前沿趋势篇.md)** | MCP/A2A 演进、端侧 Agent、Agent Economy、多模态 | 22 题 |
