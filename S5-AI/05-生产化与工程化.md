...
- [监控与评估](#-监控与评估)
  ...
  - [BFCL 函数调用评估](#57-bfcl--函数调用能力评估)
  - [GAIA 助手能力评估](#58-gaia--通用-ai-助手能力评估)
  - [LLM Judge 与 Win Rate](#59-llm-as-judge-评估器与-win-rate)
  - [AIME 数学评估](#510-数据生成评估与-aime)
  - [遥测数据采集](#511-遥测数据采集)
...
#### 5.9 LLM-as-Judge 评估器与 Win Rate
