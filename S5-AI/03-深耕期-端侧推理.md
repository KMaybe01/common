...
| 技术 | 优势 | 劣势 | 适用场景 |
|:---|:---|:---|:---|
| **[WebGPU](https://www.w3.org/TR/webgpu/)** | 极致性能，支持通用计算 | 兼容性较新 (Chrome 113+) | 大规模矩阵运算、大模型推理 |
| **WebGL** | 广泛兼容，图形渲染强 | API 繁琐，非通用计算设计 | 轻量级模型、可视化 |
| **[WebAssembly](https://webassembly.org).org)** | 接近原生 CPU 性能 | 无法利用 GPU 并行 | 传统 ML 算法、兜底方案 |
...
| 文档 | 内容 | 相关章节 |
|:---|:---|:---|
| [📊 技术选型对比合集](./07-技术选型对比合集.md) | [WebGPU](https://www.w3.org/TR/webgpu/)/[ONNX](https://onnxruntime.ai)/Transformers.js 横向对比 | 边缘计算方案、性能基准 |
| [🛠️ 开发实战与架构指南](./08-开发实战与架构指南.md) | 前端性能优化 Checklist、[WebGPU](https://www.w3.org/TR/webgpu/) 加速 | 第6章：性能优化终极 Checklist |
