...
### 1. 适合前端开发的 AI 开源项目
- **[[Vercel](https://vercel.com) AI SDK](https://github.com/[Vercel](https://vercel.com)/ai)**: 贡献 UI 组件、修复流式 Bug、完善文档。
- **[[LangChain](https://langchain.com).js](https://github.com/[LangChain](https://langchain.com)-ai/[LangChain](https://langchain.com)js)**: 添加新的 Tool 集成、优化向量存储适配器。
- **[Transformers.js](https://github.com/huggingface/[Transformers.js](https://huggingface.co/docs/transformers.js))**: 报告 [WebGPU](https://www.w3.org/TR/webgpu/) 兼容性问题、提交量化模型适配。
...
### 💻 开源项目参考
- [[Vercel](https://vercel.com) AI Chatbot](https://github.com/[Vercel](https://vercel.com)/ai-chatbot)
- [MCP Servers](https://github.com/modelcontextprotocol/servers)

### 🌐 社区与讨论
- [Vercel AI Discord](https://discord.gg/Vercel) | AI Engineering Reddit
