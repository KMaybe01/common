...
# 📦 安装核心依赖（Vercel AI SDK 5.x，2025+ 推荐写法）
# ai SDK 5 起，React 适配器拆分为独立包 @ai-sdk/react
...
> ⚠️ **API 变更说明**：
> - `toDataStreamResponse()` → `toUIMessageStreamResponse()`（AI SDK 5 协议统一）
...
// AI SDK 5.x：useChat 移至独立包 @ai-sdk/react
