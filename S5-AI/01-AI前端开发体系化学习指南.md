...
> 💡 长文档导航：点击章节跳转，建议配合搜索使用

### 🧭 学习路径
- [🗺️ 学习路线图总览](#️-学习路线图总览)
- [📂 **阶段文档拆分列表** (点击跳转独立文档)](#-阶段文档拆分列表)
- [🟢 阶段一：入门期 - AI 聊天室](./02-入门期-AI聊天室.md)
- [🔵 阶段二：进阶期 - RAG 应用](./03-进阶期-RAG应用.md)
- [🟣 阶段三：深耕期 - 端侧推理](./04-深耕期-端侧推理.md)
- [🔴 阶段四：专家期 - 全自动 Agent](./05-专家期-Agent设计.md)
- [🟠 阶段五：生产化与工程化](./06-生产化与工程化.md)
- [⚪ 阶段六：前沿技术与生态](./07-前沿技术与生态.md)
...
- [📦 常用 AI UI 组件库推荐 / 前端组件库对比](#📦-常用-ai-ui-组件库推荐)
...
> 📑 **为方便学习，已将六个阶段拆分为独立文档**，点击链接可跳转至对应阶段详细内容。

| 编号 | 阶段名称 | 文档链接 | 核心内容 |
|:---:|:---|:---|:---|
| 01 | 总览与完整指南 | [01-AI前端开发体系化学习指南.md](./01-AI前端开发体系化学习指南.md) | 学习路线、技术对比、附录、FAQ |
| 02 | 🟢 入门期 - AI 聊天室 | [02-入门期-AI聊天室.md](./02-入门期-AI聊天室.md) | API 调用、流式响应、聊天界面 |
| 03 | 🔵 进阶期 - RAG 应用 | [03-进阶期-RAG应用.md](./03-进阶期-RAG应用.md) | 文档解析、向量化、语义检索 |
| 04 | 🟣 深耕期 - 端侧推理 | [04-深耕期-端侧推理.md](./04-深耕期-端侧推理.md) | Transformers.js、WebGPU 加速 |
| 05 | 🔴 专家期 - 全自动 Agent | [05-专家期-Agent设计.md](./05-专家期-Agent设计.md) | 工具调用、ReAct 模式、任务编排 |
| 06 | 🟠 生产化与工程化 | [06-生产化与工程化.md](./06-生产化与工程化.md) | 安全防护、性能优化、监控评估 |
| 07 | ⚪ 前沿技术与生态 | [07-前沿技术与生态.md](./07-前沿技术与生态.md) | MCP、A2A、前沿协议 |
