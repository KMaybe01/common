...
> 
> 📌 **2026 版新增**：源码级原理、Vue 3.4+ 新特性、项目实战重难点、内存泄漏排查、深度面试追问题
...
- [📦 第一部分：核心基础](#第一部分核心基础)
  ...
  - [2️⃣➕ Vue 版本迭代史（2014—2026）](#2️⃣vue-版本迭代史20142026)
  - [3️⃣ Vue 3 新特性详解](#3️⃣-vue-3-新特性详解)
  - [4️⃣ 响应式原理深入](#4️⃣-响应式原理深入)
  - [5️⃣ 组合式 API 完全指南](#5️⃣-组合式-api-完全指南)
  - [6️⃣ 模板语法完全参考](#6️⃣-模板语法完全参考)
  - [7️⃣ mixin / extends 合并策略](#7️⃣-mixin--extends-合并策略)
- [🚀 第二部分：高级特性](#第二部分高级特性)
  - [1️⃣ 组件通信完全指南](#1️⃣-组件通信完全指南)
  - [2️⃣ 生命周期详解](#2️⃣-生命周期详解)
  - [3️⃣ 模板与渲染进阶](#3️⃣-模板与渲染进阶)
  - [4️⃣ 路由系统详解](#4️⃣-路由系统详解)
  - [5️⃣ 状态管理](#5️⃣-状态管理)
  - [6️⃣ 组合式 API 进阶](#6️⃣-组合式-api-进阶)
  - [7️⃣ 单文件组件最佳实践](#7️⃣-单文件组件最佳实践)
  - [8️⃣ Vue 生态](#8️⃣-vue-生态)
  - [9️⃣ 生态深度解析](#9️⃣-生态深度解析)
...
- [🔬 第五部分：源码级原理深度解析](#第五部分源码级原理深度解析)
  - [1️⃣ 虚拟 DOM Patch 过程详解](#1️⃣-虚拟-dom-patch-过程详解)
  - [2️⃣ 编译器优化源码分析](#2️⃣-编译器优化源码分析)
  - [3️⃣ effectScope 副作用作用域](#3️⃣-effectscope-副作用作用域)
- [🆕 第六部分：Vue 3.4+ 新特性深度解析](#第六部分vue-34-新特性深度解析)
  - [1️⃣ defineModel 双向绑定宏](#1️⃣-definemodel-双向绑定宏)
  - [2️⃣ 响应式 Props 解构](#2️⃣-响应式-props-解构)
  - [3️⃣ 解析器重写性能提升](#3️⃣-解析器重写性能提升)
- [🏗️ 第七部分：项目实战重难点](#第七部分项目实战重难点)
  - [1️⃣ 微前端与 Vue 3](#1️⃣-微前端与-vue-3)
  - [2️⃣ SSR 服务端渲染实战](#2️⃣-ssr-服务端渲染实战)
  - [3️⃣ 性能监控与埋点](#3️⃣-性能监控与埋点)
  - [4️⃣ 大型项目架构设计](#4️⃣-大型项目架构设计)
- [🐛 第八部分：常见 Bug 与调试技巧](#第八部分常见-bug-与调试技巧)
  - [1️⃣ 响应式丢失问题](#1️⃣-响应式丢失问题)
  - [2️⃣ 内存泄漏排查](#2️⃣-内存泄漏排查)
  - [3️⃣ TypeScript 类型推导失败](#3️⃣-typescript-类型推导失败)
  - [4️⃣ 调试技巧](#4️⃣-调试技巧)
- [🤖 Vue in AI Era](#-vue-in-ai-era)
- [🎯 第九部分：面试题汇总](#第九部分面试题汇总)
  - [Q1-Q13 基础面试题](#q1-响应式原理)
  - [Q14-Q20 深度追问](#q14-vue-3-vs-react-19-signals)
- [📚 推荐学习资源](#📚-推荐学习资源)
- [🔗 官方参考链接](#🔗-官方参考链接)
...
| [🏠 返回主指南](../README.md) | [➡️ 下一章：React 19](./02-React19.md) |
|:---:|:---:|
