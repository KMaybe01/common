...
- [📦 第1章：起航Vue 3之旅](#-第1章起航vue-3之旅)
- [📦 第2章：环境搭建与项目创建](#-第2章环境搭建与项目创建)
- [📦 第3章：Composition API](#-第3章composition-api)
- [📦 第4章：响应式系统原理](#-第4章响应式系统原理)
- [📦 第5章：组件系统](#-第5章组件系统)
- [📦 第6章：模板语法与指令](#-第6章模板语法与指令)
- [📦 第7章：生命周期与组件通信](#-第7章生命周期与组件通信)
- [📦 第8章：Vue Router 路由系统](#-第8章vue-router-路由系统)
- [📦 第9章：Pinia 状态管理](#-第9章pinia-状态管理)
- [📦 第10章：常用 Composition API 工具函数](#-第10章常用-composition-api-工具函数)
- [📦 第11章：自定义 Hooks 与逻辑复用](#-第11章自定义-hooks-与逻辑复用)
- [📦 第12章：Vue 3 + TypeScript 集成](#-第12章vue-3--typescript-集成)
- [📦 第13章：性能优化与编译原理](#-第13章性能优化与编译原理)
- [📦 第14章：全栈实战与部署](#-第14章全栈实战与部署)
- [🎯 高频面试题精选](#-高频面试题精选)
...
| 版本 | 年份 | 核心变化 | 对开发者的影响 |
|------|------|---------|--------------|
| **Vue 1.0** | 2014 | 数据绑定 + 指令系统 | 从 jQuery 到声明式 |
| **Vue 2.0** | 2016 | 虚拟 DOM、组件化 | 生态爆炸，成为主流 |
| **Vue 3.0** | 2020 | Proxy 响应式、Composition API | 性能大幅提升 |
| **Vue 3.3** | 2023 | 泛型组件、defineModel | TS 体验提升 |
| **Vue 3.4** | 2024 | 解析器重写（+41%） | 编译速度显著提升 |
...
```mermaid
graph TD
    start["setup()"] --> beforeCreate["onBeforeMount"]
    beforeCreate --> created["onMounted"]
