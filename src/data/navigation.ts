...
export const navConfig: NavItem[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: '⚛️ React 中高级面试通关指南', link: '/S4-面试冲刺/React-中高级前端面试通关指南' },
      { text: '🅰️ Angular 中高级面试通关指南', link: '/S4-面试冲刺/Angular-中高级前端面试通关指南' },
      { text: '📌 反向面试', link: '/S4-面试冲刺/05-反向面试' },
      { text: '📝 简历', link: '/S4-面试冲刺/01-简历' },
      { text: '⚛️ 简历问题（React）', link: '/S4-面试冲刺/02-简历问题' },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        text: '📝 面试篇',
        items: [
          { text: '📐 基础篇', link: '/S5-AI/面试篇/01-基础篇' },
          { text: '🧰 工具协议篇', link: '/S5-AI/面试篇/02-工具协议篇' },
          { text: '🧠 大模型基础篇', link: '/S5-AI/面试篇/03-大模型基础篇' },
          { text: '🔧 框架工具链篇', link: '/S5-AI/面试篇/04-框架工具链篇' },
          { text: '🚀 实战项目篇', link: '/S5-AI/面试篇/05-实战项目篇' },
          { text: '🔮 前沿趋势篇', link: '/S5-AI/面试篇/06-前沿趋势篇' },
        ],
      },
      {
        text: '📚 课程实战',
