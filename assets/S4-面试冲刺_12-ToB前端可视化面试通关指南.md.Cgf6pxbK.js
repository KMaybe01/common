...
<span class="line"><span>└─ 长期断连（&gt;5min）→ 全量刷新，保证数据一致性</span></span></code></pre></div><hr><h3 id="🔗-专题-3-图可视化-拓扑-sub-sup-高频-⭐⭐⭐⭐-sup-sub" tabindex="-1">🔗 专题 3：图可视化 / 拓扑 &lt;sub&gt;&lt;sup&gt;（高频 ⭐⭐⭐⭐）&lt;/sup&gt;&lt;/sub&gt; <a class="header-anchor" href="#🔗-专题-3-图可视化-拓扑-sub-sup-高频-⭐⭐⭐⭐-sup-sub" aria-label="Permalink to &quot;🔗 专题 3：图可视化 / 拓扑 &lt;sub&gt;&lt;sup&gt;（高频 ⭐⭐⭐⭐）&lt;/sup&gt;&lt;/sub&gt;&quot;">​</a></h3><hr><h4 id="🎯-q6-万级节点网络拓扑图怎么优化-⭐⭐⭐⭐⭐" tabindex="-1">🎯 Q6：万级节点网络拓扑图怎么优化？ ⭐⭐⭐⭐⭐ <a class="header-anchor" href="#🎯-q6-万级节点网络拓扑图怎么优化-⭐⭐⭐⭐⭐" aria-label="Permalink to &quot;🎯 Q6：万级节点网络拓扑图怎么优化？ ⭐⭐⭐⭐⭐&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>回答结构：四维优化——布局、渲染、交互、数据</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>├─ 混合使用：G6 做拓扑 + D3 做定制组件</span></span></code></pre></div><hr><h3 id="🏗️-专题-4-仪表盘系统架构-sub-sup-高频-⭐⭐⭐⭐-sup-sub" tabindex="-1">🏗️ 专题 4：仪表盘系统架构 &lt;sub&gt;&lt;sup&gt;（高频 ⭐⭐⭐⭐）&lt;/sup&gt;&lt;/sub&gt; <a class="header-anchor" href="#🏗️-专题-4-仪表盘系统架构-sub-sup-高频-⭐⭐⭐⭐-sup-sub" aria-label="Permalink to &quot;🏗️ 专题 4：仪表盘系统架构 &lt;sub&gt;&lt;sup&gt;（高频 ⭐⭐⭐⭐）&lt;/sup&gt;&lt;/sub&gt;&quot;">​</a></h3><hr><h4 id="🎯-q8-企业级仪表盘系统架构怎么设计-⭐⭐⭐⭐" tabindex="-1">🎯 Q8：企业级仪表盘系统架构怎么设计？ ⭐⭐⭐⭐ <a class="header-anchor" href="#🎯-q8-企业级仪表盘系统架构怎么设计-⭐⭐⭐⭐" aria-label="Permalink to &quot;🎯 Q8：企业级仪表盘系统架构怎么设计？ ⭐⭐⭐⭐&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>回答结构：四层架构——数据层 → 图表层 → 布局层 → 管理层</span></span>
<span class="line"><span></span></span>
<span class="line"><span>┌────────────────────────────────────────────────────────────┐</span></span>
...
<span class="line"><span>└─ 数据刷选：鼠标框选时间段查看明细</span></span></code></pre></div><hr><h2 id="四、📋-项目落地实战-sub-sup-star-模板-亮点映射-sup-sub" tabindex="-1">四、📋 项目落地实战 &lt;sub&gt;&lt;sup&gt;（STAR 模板 + 亮点映射）&lt;/sup&gt;&lt;/sub&gt; <a class="header-anchor" href="#四、📋-项目落地实战-sub-sup-star-模板-亮点映射-sup-sub" aria-label="Permalink to &quot;四、📋 项目落地实战 &lt;sub&gt;&lt;sup&gt;（STAR 模板 + 亮点映射）&lt;/sup&gt;&lt;/sub&gt;&quot;">​</a></h2><h3 id="_4-1-🗺️-面试回答模板-地图性能优化" tabindex="-1">4.1 🗺️ 面试回答模板：地图性能优化 <a class="header-anchor" href="#_4-1-🗺️-面试回答模板-地图性能优化" aria-label="Permalink to &quot;4.1 🗺️ 面试回答模板：地图性能优化&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>30 秒版：</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><h4 id="usemap-——-openlayers-react-hook" tabindex="-1">useMap —— OpenLayers React Hook <a class="header-anchor" href="#usemap-——-openlayers-react-hook" aria-label="Permalink to &quot;useMap —— OpenLayers React Hook&quot;">​</a></h4><div class="language-typescript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// ===== 核心 Hook：OpenLayers 地图管理 =====</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><h3 id="_6-3-⚡-react-可视化高性能模式" tabindex="-1">6.3 ⚡ React 可视化高性能模式 <a class="header-anchor" href="#_6-3-⚡-react-可视化高性能模式" aria-label="Permalink to &quot;6.3 ⚡ React 可视化高性能模式&quot;">​</a></h3><h4 id="模式-1-图表容器虚拟化-大数据量-dashboard" tabindex="-1">模式 1：图表容器虚拟化（大数据量 Dashboard） <a class="header-anchor" href="#模式-1-图表容器虚拟化-大数据量-dashboard" aria-label="Permalink to &quot;模式 1：图表容器虚拟化（大数据量 Dashboard）&quot;">​</a></h4><div class="language-typescript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 问题：Dashboard 10+ 图表同时渲染 → 首屏白屏</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>R（结果）：页面切换 &lt;200ms，CPU 占用 &lt;30%，渲染帧率 60fps。&quot;</span></span></code></pre></div><h3 id="_6-8-🏆-react-可视化项目亮点映射表" tabindex="-1">6.8 🏆 React 可视化项目亮点映射表 <a class="header-anchor" href="#_6-8-🏆-react-可视化项目亮点映射表" aria-label="Permalink to &quot;6.8 🏆 React 可视化项目亮点映射表&quot;">​</a></h3><table tabindex="0"><thead><tr><th>技术点</th><th>在项目中的落地</th><th>面试话术</th></tr></thead><tbody><tr><td><strong>useTransition</strong></td><td>5GC 测试平台维度切换</td><td>&quot;StartTransition 标记为非紧急更新，切换图表时间范围不阻塞搜索输入&quot;</td></tr><tr><td><strong>useDeferredValue</strong></td><td>5GC 测试平台树表格</td><td>&quot;树数据 600+ 行编辑，useDeferredValue 延迟渲染让输入框不卡顿&quot;</td></tr><tr><td><strong>Web Worker + React</strong></td><td>LI-OAM 日志解密</td><td>&quot;百万行日志 Web Worker 并行解密，主线程只负责 setState 渲染&quot;</td></tr><tr><td><strong>Suspense + lazy</strong></td><td>AeMS 仪表盘</td><td>&quot;ECharts/G6/OL 三个库按路由懒加载，首屏体积减少 60%&quot;</td></tr><tr><td><strong>SWR + ECharts</strong></td><td>FMS Dashboard</td><td>&quot;SWR 缓存优先 + 后台刷新，图表切换瞬间展示缓存数据&quot;</td></tr><tr><td><strong>Zustand 联动</strong></td><td>告警多图表联动</td><td>&quot;hover 高亮 / 筛选器跨图表同步，Zustand subscribe 精准更新&quot;</td></tr></tbody></table><hr><h3 id="_6-9-🧠-web-worker-在-react-可视化中的深度实践" tabindex="-1">6.9 🧠 Web Worker 在 React 可视化中的深度实践 <a class="header-anchor" href="#_6-9-🧠-web-worker-在-react-可视化中的深度实践" aria-label="Permalink to &quot;6.9 🧠 Web Worker 在 React 可视化中的深度实践&quot;">​</a></h3><blockquote><p><strong>场景：</strong> 力导向布局计算 / 十万级数据降采样 / CSV 数据解析 — 这些 CPU 密集型任务不能阻塞主线程</p></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// ===== 专用 Worker Hook：在 React 中管理 Worker 生命周期 =====</span></span>
<span class="line"><span>function useWorker&lt;TInput, TOutput&gt;(</span></span>
<span class="line"><span>  workerFactory: () =&gt; Worker,</span></span>
<span class="line"><span>  options?: {</span></span>
<span class="line"><span>    onMessage?: (data: TOutput) =&gt; void</span></span>
<span class="line"><span>    onError?: (error: ErrorEvent) =&gt; void</span></span>
<span class="line"><span>    transferable?: boolean  // 是否使用 Transferable Objects 零拷贝</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>) {</span></span>
<span class="line"><span>  const workerRef = useRef&lt;Worker | null&gt;(null)</span></span>
<span class="line"><span>  const callbacksRef = useRef&lt;Map&lt;number, { resolve, reject }&gt;&gt;(new Map())</span></span>
<span class="line"><span>  const idRef = useRef(0)</span></span>
<span class="line"><span></span></span>
<span class="line"><span>  // 初始化 Worker（仅一次，组件卸载时终止）</span></span>
<span class="line"><span>  useEffect(() =&gt; {</span></span>
<span class="line"><span>    const worker = workerFactory()</span></span>
<span class="line"><span>    workerRef.current = worker</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    worker.onmessage = (e: MessageEvent&lt;{ id: number; result: TOutput; error?: string }&gt;) =&gt; {</span></span>
<span class="line"><span>      const cb = callbacksRef.current.get(e.data.id)</span></span>
<span class="line"><span>      if (!cb) return</span></span>
<span class="line"><span>      if (e.data.error) cb.reject(new Error(e.data.error))</span></span>
<span class="line"><span>      else cb.resolve(e.data.result)</span></span>
<span class="line"><span>      callbacksRef.current.delete(e.data.id)</span></span>
<span class="line"><span>      options?.onMessage?.(e.data.result)</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    worker.onerror = (err) =&gt; {</span></span>
<span class="line"><span>      options?.onError?.(err)</span></span>
<span class="line"><span>      // 避坑：Worker 崩溃后重建</span></span>
<span class="line"><span>      console.warn(&#39;Worker crashed, recreating...&#39;)</span></span>
<span class="line"><span>      workerRef.current?.terminate()</span></span>
<span class="line"><span>      workerRef.current = workerFactory()</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    return () =&gt; {</span></span>
<span class="line"><span>      workerRef.current?.terminate()</span></span>
<span class="line"><span>      callbacksRef.current.clear()</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>  }, [])</span></span>
<span class="line"><span></span></span>
<span class="line"><span>  // 发送任务并返回 Promise（RPC 模式）</span></span>
<span class="line"><span>  const postTask = useCallback((data: TInput, transfer?: Transferable[]) =&gt; {</span></span>
<span class="line"><span>    return new Promise&lt;TOutput&gt;((resolve, reject) =&gt; {</span></span>
<span class="line"><span>      const id = ++idRef.current</span></span>
<span class="line"><span>      callbacksRef.current.set(id, { resolve, reject })</span></span>
<span class="line"><span>      workerRef.current?.postMessage({ id, data }, transfer || [])</span></span>
<span class="line"><span>    })</span></span>
<span class="line"><span>  }, [])</span></span>
<span class="line"><span></span></span>
<span class="line"><span>  // 批量任务（并发限制）</span></span>
<span class="line"><span>  const postBatch = useCallback(async (</span></span>
<span class="line"><span>    tasks: TInput[],</span></span>
<span class="line"><span>    concurrency: number = navigator.hardwareConcurrency - 1</span></span>
<span class="line"><span>  ) =&gt; {</span></span>
<span class="line"><span>    const results: TOutput[] = []</span></span>
<span class="line"><span>    const pool = Array.from({ length: concurrency }, async (_, i) =&gt; {</span></span>
<span class="line"><span>      while (tasks.length &gt; 0) {</span></span>
<span class="line"><span>        const task = tasks.shift()!</span></span>
<span class="line"><span>        results.push(await postTask(task))</span></span>
<span class="line"><span>      }</span></span>
<span class="line"><span>    })</span></span>
<span class="line"><span>    await Promise.all(pool)</span></span>
<span class="line"><span>    return results</span></span>
<span class="line"><span>  }, [postTask])</span></span>
<span class="line"><span></span></span>
<span class="line"><span>  return { postTask, postBatch, workerRef }</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>// ===== 实战：Web Worker 做力导向布局 =====</span></span>
<span class="line"><span>// force-layout.worker.ts</span></span>
<span class="line"><span>self.onmessage = (e) =&gt; {</span></span>
<span class="line"><span>  const { id, data } = e.data  // { nodes, edges, width, height }</span></span>
<span class="line"><span>  const simulation = d3.forceSimulation(data.nodes)</span></span>
<span class="line"><span>    .force(&#39;link&#39;, d3.forceLink(data.edges).distance(100))</span></span>
<span class="line"><span>    .force(&#39;charge&#39;, d3.forceManyBody().strength(-300))</span></span>
<span class="line"><span>    .force(&#39;center&#39;, d3.forceCenter(data.width / 2, data.height / 2))</span></span>
<span class="line"><span>    .stop()</span></span>
<span class="line"><span></span></span>
<span class="line"><span>  // 避坑：力导向需要 tick N 次收敛，而非一次到位</span></span>
<span class="line"><span>  const N = Math.min(300, Math.ceil(Math.log(data.nodes.length) * 50))</span></span>
<span class="line"><span>  for (let i = 0; i &lt; N; i++) simulation.tick()</span></span>
<span class="line"><span></span></span>
<span class="line"><span>  // 只返回坐标，不返回 DOM 操作（纯计算）</span></span>
<span class="line"><span>  self.postMessage({</span></span>
<span class="line"><span>    id,</span></span>
<span class="line"><span>    result: data.nodes.map(n =&gt; ({ id: n.id, x: n.x, y: n.y }))</span></span>
<span class="line"><span>  })</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>// ===== React 组件中使用 =====</span></span>
<span class="line"><span>function ForceGraph({ nodes, edges }: { nodes: Node[]; edges: Edge[] }) {</span></span>
<span class="line"><span>  const { postTask } = useWorker&lt;LayoutInput, LayoutResult&gt;(</span></span>
<span class="line"><span>    () =&gt; new Worker(new URL(&#39;./force-layout.worker.ts&#39;, import.meta.url))</span></span>
<span class="line"><span>  )</span></span>
<span class="line"><span>  const [positions, setPositions] = useState&lt;LayoutResult&gt;([])</span></span>
<span class="line"><span></span></span>
<span class="line"><span>  useEffect(() =&gt; {</span></span>
<span class="line"><span>    // ★ 避免 1 万节点以上在 Worker 中做完整力计算</span></span>
<span class="line"><span>    // 超过 5000 节点先用聚类降维，再对簇内节点算局部布局</span></span>
<span class="line"><span>    if (nodes.length &gt; 5000) {</span></span>
<span class="line"><span>      setPositions(clusterThenLayout(nodes))  // 聚类降维方案</span></span>
<span class="line"><span>      return</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>    postTask({ nodes, edges, width: 800, height: 600 })</span></span>
<span class="line"><span>      .then(setPositions)</span></span>
<span class="line"><span>  }, [nodes, edges])</span></span>
<span class="line"><span></span></span>
<span class="line"><span>  // 注意：positions 变化不触发 Worker 重新计算</span></span>
<span class="line"><span>  // 这里只做纯渲染，不涉及 DOM diff</span></span>
<span class="line"><span>  return (</span></span>
<span class="line"><span>    &lt;svg&gt;</span></span>
<span class="line"><span>      {positions.map(p =&gt; &lt;circle key={p.id} cx={p.x} cy={p.y} r={4} /&gt;)}</span></span>
<span class="line"><span>    &lt;/svg&gt;</span></span>
<span class="line"><span>  )</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>// 面试深挖：为什么用 idRef + Map 做 RPC 而不是直接 onmessage？</span></span>
<span class="line"><span>// 答案：因为 postMessage 是异步的，多个任务可能乱序返回，</span></span>
<span class="line"><span>// 用 id 匹配请求/响应，保证并发任务的结果不乱。</span></span></code></pre></div><h3 id="_6-10-🔍-react-可视化性能诊断与调优" tabindex="-1">6.10 🔍 React 可视化性能诊断与调优 <a class="header-anchor" href="#_6-10-🔍-react-可视化性能诊断与调优" aria-label="Permalink to &quot;6.10 🔍 React 可视化性能诊断与调优&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>===== 诊断工具链 =====</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>└─ 用户拖拽 1 个节点 → ~16ms 内完成（只更新相邻节点）</span></span></code></pre></div><blockquote><p><strong>深度解析：</strong></p><p>考察点：能否把&quot;学术界算法&quot;转化为&quot;工程方案&quot;。</p><p>加分项：给出了具体的数据（2s / 100ms / 16ms）——展示你做过实测，不是纸上谈兵。</p></blockquote><hr><h3 id="追问链路-7-react-可视化调和-→-深度" tabindex="-1">追问链路 7：React + 可视化调和 → 深度 <a class="header-anchor" href="#追问链路-7-react-可视化调和-→-深度" aria-label="Permalink to &quot;追问链路 7：React + 可视化调和 → 深度&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>面试官：&quot;React 的声明式范式和可视化库的命令式 API 冲突，你怎么调和？&quot;</span></span>
<span class="line"><span>                        ↓</span></span>
...
<span class="line"><span>  }, [])</span></span></code></pre></div><blockquote><p><strong>深度解析：</strong></p><p>考察点：React 18 开发环境的特殊性——面试官知道很多人不知道。</p><p>加分项：提到&quot;StrictMode double-invoke&quot;——展示你对 React 18 变更的了解。</p><p>⚠️ 避坑：不要抱怨 StrictMode——面试官会认为你对 React 生态的变更抵触。</p></blockquote><hr><h2 id="八、💬-反问环节推荐问题-sub-sup-展示深度与视野-sup-sub" tabindex="-1">八、💬 反问环节推荐问题 &lt;sub&gt;&lt;sup&gt;（展示深度与视野）&lt;/sup&gt;&lt;/sub&gt; <a class="header-anchor" href="#八、💬-反问环节推荐问题-sub-sup-展示深度与视野-sup-sub" aria-label="Permalink to &quot;八、💬 反问环节推荐问题 &lt;sub&gt;&lt;sup&gt;（展示深度与视野）&lt;/sup&gt;&lt;/sub&gt;&quot;">​</a></h2><h3 id="展示深度的反问" tabindex="-1">展示深度的反问 <a class="header-anchor" href="#展示深度的反问" aria-label="Permalink to &quot;展示深度的反问&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>✅ &quot;团队目前用哪套可视化方案？在十万级数据场景下遇到过性能瓶颈吗？&quot;</span></span>
...
<span class="line"><span>└─────────────────────────────────────────────────────────┘</span></span></code></pre></div><hr><h2 id="✅-附-c-可视化面试自检清单-sub-sup-出发前逐项打勾-✅-记录掌握进度-sup-sub" tabindex="-1">✅ 附 C：可视化面试自检清单 &lt;sub&gt;&lt;sup&gt;（出发前逐项打勾 ✅ 记录掌握进度）&lt;/sup&gt;&lt;/sub&gt; <a class="header-anchor" href="#✅-附-c-可视化面试自检清单-sub-sup-出发前逐项打勾-✅-记录掌握进度-sup-sub" aria-label="Permalink to &quot;✅ 附 C：可视化面试自检清单 &lt;sub&gt;&lt;sup&gt;（出发前逐项打勾 ✅ 记录掌握进度）&lt;/sup&gt;&lt;/sub&gt;&quot;">​</a></h2><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>╔═══════════════════════════════════════════════════════════╗</span></span>
...
<span class="line"><span>└────────────────────────────────────────────────────────────┘</span></span></code></pre></div><blockquote><p><strong>🚀 最后的建议：</strong> 把这份指南中的项目亮点映射到你的实际项目中，用你自己的 STAR 故事替换模板中的 AeMS/LI-OAM 案例。面试官最爱听&quot;你做了什么&quot;，而不是&quot;指南上写了什么&quot;。</p></blockquote>`,15))])}const C=r(E,[["render",o]]);export{F as __pageData,C as default};
